...
class EntityLinkWebService(DefinitionBase):
    ...
    def entitylinking(self,keywords_input):
        ...
        keywords=keywords_input.encode("utf-8").split(" ")
        keywordsURL = []
        keywords_search=[]
...
#
# # input=u"国奥 马晓旭 殷家军 中国人民解放军国防科学技术大学 沈阳 国奥队 雨水 训练 奥体中心 外场 球员"
# input=u"苹果 乔布斯 jobs"
# xx=EntityLinkWebService()
#
# print xx.entitylinking(input)
