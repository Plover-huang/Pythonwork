...
import urllib2, socket, time,urllib
...
class SearchResult:
    ...
    def setSubcontent(self,subcontent):
    ...
    def printIt(self, prefix = ''):
        ...
        print 'subcontent\t->',self.subcontent
    ...
    def writeFile(self, filename):
        ...
        try:
            ...
            file.write('subcontent:' + self.subcontent + '\n')
        ...
        if (type(div) != types.NoneType):
            ...
            if(len(lis) > 0):
                for li in lis:
                    ...
                    subcontent = self.extractSearchResults(html)
                    result.setContent(subcontent)

                    result.writeFile(str(result.getTitle().strip(' ')+'md'))
